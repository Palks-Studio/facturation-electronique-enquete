...
🇬🇧 [Read the complete investigation in PDF format](https://palks-studio.com/assets/pdf/electronic-invoicing-investigation.pdf)

Les 7 chapitres sont également disponibles séparément en français et en anglais dans [`chapitres/`](chapitres/).

Le registre des sources officielles utilisées est disponible en français dans [`sources/sources.md`](sources/sources.md) et en anglais dans [`sources/sources-en.md`](sources/sources-en.md).
